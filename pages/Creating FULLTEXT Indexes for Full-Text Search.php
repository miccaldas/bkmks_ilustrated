    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/Creating FULLTEXT Indexes for Full-Text Search.png" class="center" alt="new_Creating FULLTEXT Indexes for Full-Text Search">
<br>
<h1 class="f-6 lh-solid gray bold center">Creating FULLTEXT Indexes for Full-Text Search</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">in this tutorial, you will learn how to define the full-text index for performing various full-text searches in MySQL.</h3><br><br>
<a href="https://www.mysqltutorial.org/activating-full-text-searching.aspx/" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
