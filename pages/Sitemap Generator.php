    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/Sitemap Generator.png" class="center" alt="new_Sitemap Generator">
<br>
<h1 class="f-6 lh-solid gray bold center">Sitemap Generator</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">Creates sitemaps autommaticaly</h3><br><br>
<a href="https://www.linuxsecrets.com/3585-creating-sitemap-in-linux-terminal" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
