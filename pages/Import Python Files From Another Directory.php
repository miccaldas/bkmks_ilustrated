    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/Import Python Files From Another Directory.png" class="center" alt="new_Import Python Files From Another Directory">
<br>
<h1 class="f-6 lh-solid gray bold center">Import Python Files From Another Directory</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">Import Python Files From Another Directory</h3><br><br>
<a href="https://gist.github.com/MRobertEvers/55a989b4883ea8d7715d2e156627f034" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
