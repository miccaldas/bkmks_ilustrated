...
<head>
  ...
  <meta name="description" content="Fuzzy string matching like a boss. It uses Levenshtein Distance to calculate the differences">
...
<?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
  <div id="flex-container" class="flex mt=2 mb=2" style="padding-top:20px">
    ...
    <div id="col2" class="w-80 order-1" style="display:flex;justify-content:center;align-items:center">>
      <div id='content'> 
        <img src="screenshots/FuzzyWuzzy.png" class="" alt="new_FuzzyWuzzy" style="margin:auto">
        <br>
        <br>
        <h1 class="f-6-ns lh-solid gray bold lh-title" style="margin:0 auto;position:relative;top:50px;margin-bottom:70px">FuzzyWuzzy</h1>
        <h3 class="f-5-ns bold silver f-subheadline measure lh-title" style="margin:0 auto; position:relative;left:80px;top:30px;margin-bottom:40px">Fuzzy string matching like a boss. It uses Levenshtein Distance to calculate the differences</h3>
        <br>
        <a href="https://github.com/seatgeek/fuzzywuzzy" class="f2 i mid-gray black link hover-dark-red" style="position:relative;left:350px">LINK</a>
