    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/Create MySQl's  Full Text Indexes.png" class="center" alt="new_Create MySQl's  Full Text Indexes">
<br>
<h1 class="f-6 lh-solid gray bold center">Create MySQl's  Full Text Indexes</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">Mysql's equivalent of Sqlite's virtual tables</h3><br><br>
