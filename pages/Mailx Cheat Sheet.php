    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/Mailx Cheat Sheet.png" class="center" alt="new_Mailx Cheat Sheet">
<br>
<h1 class="f-6 lh-solid gray bold center">Mailx Cheat Sheet</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">Quase todos os comandos enumerados</h3><br><br>
<a href="https://www.ibm.com/support/knowledgecenter/en/SSLTBW_2.1.0/com.ibm.zos.v2r1.bpxa500/mailx.htm" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
