...
<html>
<head>
  <title>Tachyons Build CSS</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="author" content="Mclds">
  <meta name="description" content="Tachyon CSS framework library to convert PostCSS to normal CSS">
...
<?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
  <div id="flex-container" class="flex mt=2 mb=2" style="padding-top:20px">
    ...
    <div id="col2" class="w-80 order-1" style="display:flex;justify-content:center;align-items:center">>
      <div id='content'> 
        <img src="screenshots/Tachyons Build CSS.png" class="" alt="new_Tachyons Build CSS" style="margin:auto">
        <br>
        <br>
        <h1 class="f-6-ns lh-solid gray bold lh-title" style="margin:0 auto;position:relative;top:50px;margin-bottom:70px">Tachyons Build CSS</h1>
        <h3 class="f-5-ns bold silver f-subheadline measure lh-title" style="margin:0 auto; position:relative;left:80px;top:30px;margin-bottom:40px">Tachyon CSS framework library to convert PostCSS to normal CSS</h3>
        <br>
        <a href="https://github.com/tachyons-css/tachyons-build-css" class="f2 i mid-gray black link hover-dark-red" style="position:relative;left:350px">LINK</a>
