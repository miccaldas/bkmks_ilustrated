    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/How to configure Backblaze B2 with Duplicity on Linux.png" class="center" alt="new_How to configure Backblaze B2 with Duplicity on Linux">
<br>
<h1 class="f-6 lh-solid gray bold center">How to configure Backblaze B2 with Duplicity on Linux</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">How to configure Backblaze with Duplicity. Better explained</h3><br><br>
<a href="https://help.backblaze.com/hc/en-us/articles/115001518354-How-to-configure-Backblaze-B2-with-Duplicity-on-Linux" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
