    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/PHP-CS_FIXER.png" class="center" alt="new_PHP-CS_FIXER">
<br>
<h1 class="f-6 lh-solid gray bold center">PHP-CS_FIXER</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">Corrects errors in PHP</h3><br><br>
<a href="https://tinyurl.com/yz57k4x6" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
