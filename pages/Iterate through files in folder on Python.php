    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/Iterate through files in folder on Python.png" class="center" alt="new_Iterate through files in folder on Python">
<br>
<h1 class="f-6 lh-solid gray bold center">Iterate through files in folder on Python</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">Iterate through files in a folder</h3><br><br>
<a href="https://www.geeksforgeeks.org/how-to-iterate-over-files-in-directory-using-python/" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
