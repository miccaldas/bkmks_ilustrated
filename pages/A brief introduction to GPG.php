    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/A brief introduction to GPG.png" class="center" alt="new_A brief introduction to GPG">
<br>
<h1 class="f-6 lh-solid gray bold center">A brief introduction to GPG</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">What it says on the title</h3><br><br>
<a href="https://loganmarchione.com/2015/12/brief-introduction-gpg/#Generate_a_key_pair" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
