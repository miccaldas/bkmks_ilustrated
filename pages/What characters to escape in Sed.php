...
<html>
<head>
  <title>What characters to escape in Sed</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="author" content="Mclds">
  <meta name="description" content="Characters that need escaping in Sed">
...
<?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
  <div id="flex-container" class="flex mt=2 mb=2" style="padding-top:20px">
    ...
    <div id="col2" class="w-80 order-1" style="display:flex;justify-content:center;align-items:center">>
      <div id='content'> 
        <img src="screenshots/What characters to escape in Sed.png" class="" alt="new_What characters to escape in Sed" style="margin:auto">
        <br>
        <br>
        <h1 class="f-6-ns lh-solid gray bold lh-title" style="margin:0 auto;position:relative;top:50px;margin-bottom:70px">What characters to escape in Sed</h1>
        <h3 class="f-5-ns bold silver f-subheadline measure lh-title" style="margin:0 auto; position:relative;left:80px;top:30px;margin-bottom:40px">Characters that need escaping in Sed</h3>
        <br>
        <a href="https://tinyurl.com/y49uo42g" class="f2 i mid-gray black link hover-dark-red" style="position:relative;left:350px">LINK</a>
