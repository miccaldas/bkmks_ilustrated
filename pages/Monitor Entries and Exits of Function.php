    ...
    <?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
            <div id='content'>
<img src="screenshots/Monitor Entries and Exits of Function.png" class="center" alt="new_Monitor Entries and Exits of Function">
<br>
<h1 class="f-6 lh-solid gray bold center">Monitor Entries and Exits of Function</h1>
<h3 class="f-4 ml7 ph7 bold silver center f-subheadline lh-title">Loguru based function that monitors info going, exiting a function</h3><br><br>
<a href="https://tinyurl.com/y55kh9oa" class="f1 lh-title washed-red fw6 ml5 ph7 db black link hover-dark-red">LINK</a>
