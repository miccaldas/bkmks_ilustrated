...
<html>
<head>
  <title>Monitor Entries and Exits of Function</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="author" content="Mclds">
  <meta name="description" content="Loguru based function that monitors info going, exiting a function">
...
<?php include '/usr/share/nginx/html/bkmks_ilustrated/partials/header.php'; ?>
  <div id="flex-container" class="flex mt=2 mb=2" style="padding-top:20px">
    ...
    <div id="col2" class="w-80 order-1" style="display:flex;justify-content:center;align-items:center">>
      <div id='content'> 
        <img src="screenshots/Monitor Entries and Exits of Function.png" class="" alt="new_Monitor Entries and Exits of Function" style="margin:auto">
        <br>
        <br>
        <h1 class="f-6-ns lh-solid gray bold lh-title" style="margin:0 auto;position:relative;top:50px;margin-bottom:70px">Monitor Entries and Exits of Function</h1>
        <h3 class="f-5-ns bold silver f-subheadline measure lh-title" style="margin:0 auto; position:relative;left:80px;top:30px;margin-bottom:40px">Loguru based function that monitors info going, exiting a function</h3>
        <br>
        <a href="https://tinyurl.com/y55kh9oa" class="f2 i mid-gray black link hover-dark-red" style="position:relative;left:350px">LINK</a>
